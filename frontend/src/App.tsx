...
// Deployed as an IIS sub-application at /reportingapp (see vite.config.ts's matching
// `base` setting) -- without this, the router tries to match routes like "/reports"
// against the full "/reportingapp/reports" path and fails. Local dev serves from "/".
...
], { basename: import.meta.env.DEV ? undefined : "/reportingapp" });
